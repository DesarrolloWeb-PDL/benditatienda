...
const ES: Translations = {
  ...
  aboutBody: "Somos Bendito Cross, tu tienda de indumentaria deportiva y equipamiento para CrossFit. Ofrecemos ropa, accesorios y suplementos para entrenadores de todos los niveles.",
  ...
  whatsappDefaultMessage: "Hola, vengo de Bendito Cross...",
...
const PT: Translations = {
  ...
  aboutBody: "Somos Bendito Cross, sua loja de indumentaria deportiva e equipamento para CrossFit. Oferecemos roupas, acessórios e suplementos para treinadores de todos os níveis.",
  ...
  whatsappDefaultMessage: "Olá, vim do Bendito Cross...",
...
const EN: Translations = {
  ...
  aboutTitle: "About Us",
  aboutBody: "We are Bendito Cross, your sports clothing and CrossFit equipment store. We offer clothing, accessories and supplements for trainers of all levels.",
  ...
  whatsappDefaultMessage: "Hi, I came from Bendito Cross...",
