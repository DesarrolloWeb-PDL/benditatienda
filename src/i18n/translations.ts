...
const ES: Translations = {
  ...
  footerDescription: "Indumentaria deportiva, equipamiento y suplementos para CrossFit y entrenamiento funcional. Calidad y rendimiento.",
  ...
  footerLegalNote: "Venta de indumentaria deportiva y equipamiento. Calidad garantizada para tu entrenamiento.",
  aboutTitle: "Sobre Nosotros",
  aboutBody: "Somos Bendita Tienda, tu tienda de indumentaria deportiva y equipamiento para CrossFit. Ofrecemos ropa, accesorios y suplementos para entrenadores de todos los niveles.",
  aboutSecondaryBody: "Trabajamos con las mejores marcas para ofrecerte productos de calidad que soporten la intensidad de tu entrenamiento. Calidad y rendimiento en cada artículo.",
  ...
  whatsappDefaultMessage: "Hola, vengo de Bendita Tienda...",
  ...
  whatsappFaqSourdoughAnswer: "Vendemos indumentaria deportiva, equipamiento para CrossFit y suplementos. Todo para tu entrenamiento.",
...
const PT: Translations = {
  ...
  footerDescription: "Indumentaria deportiva, equipamento e suplementos para CrossFit e treinamento funcional. Qualidade e desempenho.",
  ...
  footerLegalNote: "Venda de indumentaria deportiva e equipamento. Qualidade garantida para seu treinamento.",
  aboutTitle: "Sobre Nos",
  aboutBody: "Somos Bendita Tienda, sua loja de indumentaria deportiva e equipamento para CrossFit. Oferecemos roupas, acessórios e suplementos para treinadores de todos os níveis.",
  aboutSecondaryBody: "Trabalhamos com as melhores marcas para oferecer produtos de qualidade que suportem a intensidade do seu treinamento. Qualidade e desempenho em cada artigo.",
  ...
  whatsappDefaultMessage: "Olá, vim do Bendita Tienda...",
  ...
  whatsappFaqSourdoughAnswer: "Vendemos indumentaria deportiva, equipamento para CrossFit e suplementos. Tudo para seu treinamento.",
...
const EN: Translations = {
  ...
  footerDescription: "Sports clothing, equipment and supplements for CrossFit and functional training. Quality and performance.",
  ...
  footerLegalNote: "Sports clothing and equipment sales. Quality guaranteed for your training.",
  aboutTitle: "About Us",
  aboutBody: "We are Bendita Tienda, your sports clothing and CrossFit equipment store. We offer clothing, accessories and supplements for trainers of all levels.",
  aboutSecondaryBody: "We work with the best brands to offer quality products that withstand the intensity of your training. Quality and performance in every item.",
  ...
  whatsappDefaultMessage: "Hi, I came from Bendita Tienda...",
  ...
  whatsappFaqSourdoughAnswer: "We sell sports clothing, CrossFit equipment and supplements. Everything for your training.",
